...
const FIXTURE_BYTES: &[u8] = include_bytes!("../parity/http-contract-v1.json");
const EXPECTED_SHA256: &str = "62fad592a33305a754353c43f6476d257f01ccf6e3cfdbf391d03717ce4796b5";
...
fn php_http_contract_is_the_reviewed_immutable_fixture() {
    ...
    assert_eq!(contract.schema, "iicp.directory.http-contract.v1");
    ...
    assert_eq!(contract.routes.len(), 43);
}
