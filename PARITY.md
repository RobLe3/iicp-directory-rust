...
Last refreshed: **2026-08-15**. Rust `v0.1.13` pins the shared
`contract-v1.10.92.json`, whose PHP runtime authority is `v1.10.92`. The
...
policy applies model/QoS admission, PHP-compatible scoring, deterministic
tie-breaking and the caller limit. MySQL candidates carry capability, runtime,
